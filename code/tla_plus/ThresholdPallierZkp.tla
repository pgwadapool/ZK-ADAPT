...
EncryptGradients(grad) ==
    ...
    /\ UNCHANGED <<public_key, private_key_shares, partial_decryptions, decrypted_gradients>>
...
PartialDecrypt(participant, enc_grad) ==
    ...
    /\ UNCHANGED <<public_key, private_key_shares, encrypted_gradients, decrypted_gradients>>
...
CombineDecryptions(enc_grad) ==
    ...
    /\ UNCHANGED <<public_key, private_key_shares, encrypted_gradients, partial_decryptions>>
...
\* Action to simulate encryption, partial decryption, and reconstruction
Next ==
...
Spec == Init /\ [][Next]_<<public_key, private_key_shares, encrypted_gradients, partial_decryptions, decrypted_gradients>>
